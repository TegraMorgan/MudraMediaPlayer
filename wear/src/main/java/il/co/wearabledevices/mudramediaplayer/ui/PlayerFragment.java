...
public class PlayerFragment extends Fragment {
    ...
    public static PlayerFragment newInstance(String param1, String param2) {
        ...
        args.putString(constants.SONG_ARTIST, param1);
        args.putString(constants.SONG_TITLE, param2);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            songArtist = getArguments().getString(constants.SONG_ARTIST);
            songTitle = getArguments().getString(constants.SONG_TITLE);
        }
    }
