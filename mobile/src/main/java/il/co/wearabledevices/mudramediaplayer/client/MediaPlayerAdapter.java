...
package il.co.wearabledevices.mudramediaplayer.client;
 ...
 * so that {@link il.co.wearabledevices.mudramediaplayer.AlbumSelectionActivity} can control music playback.
 */
public final class MediaPlayerAdapter extends PlayerAdapter {
     ...
     * created. In the onStop() method of the {@link il.co.wearabledevices.mudramediaplayer.AlbumSelectionActivity} the {@link MediaPlayer} is
     * released. Then in the onStart() of the {@link il.co.wearabledevices.mudramediaplayer.AlbumSelectionActivity} a new {@link MediaPlayer}
    ...
    public void playFromMedia(MediaMetadataCompat metadata) {
        ...
        playFile(MediaLibrary.getMusicFilename(mediaId));
    }
    */

    /**
     * Override by Tegra
     * Here we replace playback by filename to playback by file Id
     *
     * @param metadata
     */
    @Override
    ...
    private void playUri(long sId, Context context) {
        boolean mediaChanged = (sId != mFileId);
