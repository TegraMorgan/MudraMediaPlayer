...
package il.co.wearabledevices.mudramediaplayer.notifications;
...
public class MediaNotificationManager {
    ...
    private NotificationCompat.Builder buildNotification(@NonNull PlaybackStateCompat state,
        ...
        builder.setStyle(
                ...
                .setLargeIcon(MediaLibrary.getAlbumBitmap(mService, description.getMediaId()))
    ...
    private PendingIntent createContentIntent() {
        Intent openUI = new Intent(mService, AlbumSelectionActivity.class);
