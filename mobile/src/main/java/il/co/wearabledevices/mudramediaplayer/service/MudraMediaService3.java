...
import il.co.wearabledevices.mudramediaplayer.client.MediaPlayerAdapter;
...
public class MudraMediaService3 extends MediaBrowserServiceCompat {
    private static final String TAG = MudraMediaService3.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        mSession = new MediaSessionCompat(this, "MudraMediaService3");
        ...
        Log.d(TAG, "onCreate: MudraMediaService3 creating MediaSession, and MediaNotificationManager");
    }
    ...
    public void onLoadChildren(
        ...
        //TODO maybe implement it in the future
    ...
    public class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPrepare() {
            ...
            mPreparedMedia = MediaLibrary.getMetadata(MudraMediaService3.this, mediaId);
    ...
    // MediaPlayerAdapter Callback: MediaPlayerAdapter state -> MudraMediaService3.
            ...
            private void moveServiceToStartedState(PlaybackStateCompat state) {
                ...
                if (!mServiceInStartedState) {
                    ContextCompat.startForegroundService(
                            MudraMediaService3.this,
                            new Intent(MudraMediaService3.this, MudraMediaService3.class));
